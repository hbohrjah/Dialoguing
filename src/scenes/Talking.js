class Talking extends Phaser.Scene {
    ...
    init() {
        ...
        this.DBOX_FONT = 'reg_font'	    // dialog box font key
    ...
    create() {
        ...
        this.snake = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'snake').setOrigin(0, 1)
        this.snake.setDepth(1)
        this.snake.setScale(0.4)
        // input

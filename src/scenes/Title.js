class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('snake', 'img/solidSnake.png')

        // load bitmap font
        this.load.bitmapFont('gem_font', 'font/gem.png', 'font/gem.xml')
        this.load.bitmapFont('reg_font', 'font/Unnamed.png', 'font/Unnamed.xml')
    }

    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'reg_font', 'THE ODYSSEY', 32).setOrigin(0.5)
